...
download. Every knob comes from the manifest — the same document the
...
from agilerl.arena.memory.specs import DeviceSpec, GiB, ModelArch
...
def memory_group() -> None:
    """Estimate a manifest's GPU memory, and gate on whether it fits."""
...
def memory_estimate(
    ...
    All run knobs come from the manifest itself; only the device has to be
